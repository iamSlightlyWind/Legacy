...
public class Main {
    public static void main(String[] args) throws IllegalAccessException {
        ...
        Teacher teacher1 = new Teacher(2L, "Alice What now", "Female", "123-456-7890", "alice.smith@example.com", 50000.0, 5000.0);
        ...
        Teacher currentTeacher = tDao.handle("findByID", 2l);
        currentTeacher.setBasicSalary(0.0);
        tDao.handle("update", currentTeacher);
